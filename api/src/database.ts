...
import fs from 'fs';
import type { Category, Item, CreateCategoryRequest, UpdateCategoryRequest, CreateItemRequest, UpdateItemRequest } from './types';
...
export const categoryDb = {
  ...
  create: (data: CreateCategoryRequest): Category => {
    ...
    const stmt = db.prepare('INSERT INTO categories (id, name, description, created_at, updated_at) VALUES (?, ?, ?, ?, ?)');
...
export const itemDb = {
  ...
  create: (data: CreateItemRequest): Item => {
    ...
    const stmt = db.prepare('INSERT INTO items (id, name, description, category_id, quantity, skus, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
    stmt.run(id, data.name, data.description || null, data.categoryId, data.quantity, JSON.stringify(data.skus || []), now, now);
